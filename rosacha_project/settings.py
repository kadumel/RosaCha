"""
Django settings for rosacha_project project.
...
def database_config_from_url(database_url):
    ...
    if not engine:
        raise ValueError(f'Esquema de banco nao suportado em DATABASE_URL: {parsed.scheme}')
...
ROOT_URLCONF = 'rosacha_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.brand_assets',
...
WSGI_APPLICATION = 'rosacha_project.wsgi.application'
